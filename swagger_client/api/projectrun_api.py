...
class ProjectrunApi(object):
    ...
    def read_project_run(self, project_id, run_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_project_run(project_id, run_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.read_project_run_with_http_info(project_id, run_id, **kwargs)  # noqa: E501
        else:
            (data) = self.read_project_run_with_http_info(project_id, run_id, **kwargs)  # noqa: E501
            return data

    def read_project_run_with_http_info(self, project_id, run_id, **kwargs):  # noqa: E501
        """Read project test run info  # noqa: E501

        This endpoint retrieves project test run info. Project and run must be previously created  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_project_run_with_http_info(project_id, run_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_id', 'run_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
