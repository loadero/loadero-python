...
class TestApi(object):
    ...
    def create_test(self, name, start_interval, participant_timeout, mode, increment_strategy, script, project_id, **kwargs):  # noqa: E501
        ...
        :param bool mos_test: readonly: true
    ...
    def create_test_with_http_info(self, name, start_interval, participant_timeout, mode, increment_strategy, script, project_id, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'start_interval', 'participant_timeout', 'mode', 'increment_strategy', 'script', 'project_id', 'describe', 'id', 'created', 'updated', 'project_id', 'script_file_id', 'mos_test', 'deleted', 'group_count', 'participant_count']  # noqa: E501
    ...
    def update_test_with_http_info(self, name, start_interval, participant_timeout, mode, increment_strategy, script, test_id, project_id, **kwargs):  # noqa: E501
        ...
        all_params = ['name', 'start_interval', 'participant_timeout', 'mode', 'increment_strategy', 'script', 'test_id', 'project_id', 'describe', 'id', 'created', 'updated', 'project_id', 'script_file_id', 'mos_test', 'deleted', 'group_count', 'participant_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
